...
-- 索引
ALTER TABLE m03_device ADD INDEX idx_device_project (project_id);
ALTER TABLE m03_device ADD INDEX idx_device_station (station_code);
ALTER TABLE m03_device ADD INDEX idx_device_type (device_type);
ALTER TABLE m03_model ADD INDEX idx_model_type (model_type);
ALTER TABLE m03_region ADD INDEX idx_region_parent (parent_code);
ALTER TABLE m03_collision_record ADD INDEX idx_collision_project (project_id);