...
class CoordinateTransformerTest {
    ...
    void shouldTransformWgs84ToWebMercator() {
        ...
        // Web Mercator已知值：x≈12958172.7, y≈4852327.5
        assertEquals(12958172.7, result.getTargetX().doubleValue(), 1.0);
        assertEquals(4852327.5, result.getTargetY().doubleValue(), 1.0);
    }
    ...
    void shouldTransformWebMercatorBackToWgs84() {
        // 逆变换应回到原经纬度
        CoordinateTransformer.TransformResult result = transformer.transform(
                new BigDecimal("12958172.7"), new BigDecimal("4852327.5"),
    ...
    void shouldReuseOperationForBatchTransform() {
        ...
        assertEquals(12958172.7, p1[0], 1.0);
    }
}
